...
function procesar(orden){ //Funcion a la que llamara el evento onclick de los botones Compilar y Ejecutar
	...
	copiar(); //recupera y copia la zona editable en textarea respuesta_trozo, Codigo en el documento editor.js
	 ...
	 if((respuesta.indexOf("scanf")!=-1) || (respuesta.indexOf("printf")!=-1) || (respuesta.indexOf("system")!=-1) || (respuesta.indexOf("fopen")!=-1) || (respuesta.indexOf("fgets")!=-1) || (respuesta.indexOf("fputs")!=-1) || (respuesta.indexOf("remove")!=-1) || (respuesta.indexOf("rename")!=-1) || (respuesta.indexOf("malloc")!=-1) || (respuesta.indexOf("free")!=-1)){ //Primera barrera de seguridad para estas funciones
		 $( "#dialogo" ).empty();
